...
def load_arguments(self, _):
    with self.argument_context('account create') as c:
        ...
        c.argument('offer_type', required=True, help='The offer type of the subscription. For example, MS-AZR-0017P (EnterpriseAgreement) and MS-AZR-0148P (EnterpriseAgreement devTest) are available.', arg_type=get_enum_type(['MS-AZR-0017P', 'MS-AZR-0148P','MS-AZR-USGOV-0015P','MS-AZR-USGOV-0148P','MS-AZR-USGOV-0017P']))
